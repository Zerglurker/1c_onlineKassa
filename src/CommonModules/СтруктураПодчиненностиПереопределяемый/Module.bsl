...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	Реквизиты = new map;
	Реквизиты.Вставить("СуммаДокумента", Метаданные.Документы.Договор.Реквизиты.Сумма.Имя);
	Настройки.Реквизиты.Вставить(Метаданные.Документы.Договор.ПолноеИмя(), Реквизиты);
		
	Реквизиты = new map;
	Реквизиты.Вставить("СуммаДокумента", Метаданные.Документы.КассовыйЧек.Реквизиты.КонтрольнаяСумма.Имя);
	Настройки.Реквизиты.Вставить(Метаданные.Документы.КассовыйЧек.ПолноеИмя(), Реквизиты);
		
	Реквизиты = new map;
	Реквизиты.Вставить("СуммаДокумента", Метаданные.Документы.ПлатежноеПоручение.Реквизиты.Сумма.Имя);
	Настройки.Реквизиты.Вставить(Метаданные.Документы.ПлатежноеПоручение.ПолноеИмя(), Реквизиты);
